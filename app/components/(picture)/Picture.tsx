...
const Picture = () => {
  return (
    <div className='w-screen sm:w-[80%] flex gap-1 items-center justify-center'>
      ...
      <Image src='/katter.jpg' alt="katter" width="200" height="200" className='hidden sm:block'/>
      <Image src='/katter.jpg' alt="katter" width="400" height="400"className=' sm:hidden' />

      <Image src='/intelligentcube.jpg' alt="kube" width="200" height="200" className='hidden sm:block'/>
    </div>
  )
}
